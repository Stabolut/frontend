...
import { getAdminDepositAddress, purchaseEth } from "../../api/purchase/purchase";
...
class PurchaseEth extends Component {
    ...
    purchaseCoin = async (e) => {
        if (this.state.hash === "" || this.state.hash === null) {
            return this.setState({ isError: true, message: "eth hash is required!" });
        ...
        try {
            ...
            const { data } = await purchaseEth(dataObject);
            this.setState({ isError: false, isLoading: false, disable: false, visible: true, modalMessage: data.message });
                                ...
                                <div className="card card-block card-stretch card-height">
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            <div>
                                            <h5>Payment ETH Address <a  style={{color:"red",fontWeight:"bold",textDecoration:"none"}} href="https://goerlifaucet.com/" target="_blank">(Testnet)</a></h5>
 ...
 */}
                                            ...
                                            <div className="qr-code">
                                                ...
                                                ></img> */}
                                                <QRCode style={{ width: "180px", height: "180px" }} value={this.state.depositAddress} />
                                            </div>
                                        </div>
                                        <hr />
                                        <div>
