...
## Usage
  ...
  1. **Ethereum Transaction Section:** Enter the transaction hash of your Ethereum deposit in the designated field.
  2. **Ethereum Transaction Section:** Enter the transaction hash of your Bitcoin deposit in the corresponding field.
  3. Upon submitting the transaction hash, the system will process your deposit and allocate USB tokens based on the deposit amount.
